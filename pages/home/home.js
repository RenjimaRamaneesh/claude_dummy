...
Page({
  ...
  onLoad: function () {
    ...
    var bottomNavHeight = 120;
    var scrollHeight = screenHeight - statusBarHeight - 120 - bottomNavHeight;
  ...
  // Content Scroll - detect direction to expand/collapse carousel
  onContentScroll: function (e) {
    ...
    this._scrollThrottleTimer = setTimeout(function () {
      if (diff > 15 && !self.data.carouselCollapsed && scrollTop > 20) {
        self.setData({
          carouselCollapsed: true,
          carouselHeight: 0
        });
      } else if (diff < -15 && self.data.carouselCollapsed) {
        self.setData({
          carouselCollapsed: false,
          carouselHeight: 324
        });
